...
"""
import argparse, glob, io, os, shutil, struct, subprocess, tempfile, time
...
def unpack_archive(archive_path, out_dir):
    os.makedirs(out_dir,exist_ok=True)
    with open(archive_path,"rb") as f:
        assert f.read(4)==MAGIC,"Kein DCV1-Archiv"
...
def main():
    ...
    if a.cmd=="benchmark":
        ...
        unpack_archive(a.archive,a.out); print("Fertig.")
